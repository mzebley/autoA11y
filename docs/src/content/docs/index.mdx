...
<LandingFeatureGrid
  ...
  description="Build inclusive interactions with declarative HTML and automagica11y will pair empathetic defaults with smart automation to create accessibility that just… happens.
"
